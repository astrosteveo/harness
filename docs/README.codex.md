...
Complete guide for using Harness with OpenAI Codex.
...
The bootstrap file is included in the repository at `.codex/harness-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/harness/.codex/harness-codex find-skills to show available skills
```
...
```
Run ~/.codex/harness/.codex/harness-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/harness/.codex/harness-codex use-skill harness:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/harness/.codex/harness-codex bootstrap
```
...
**Location:** `~/.codex/harness/.codex/harness-codex`
...
**Location:** `~/.codex/harness/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/harness/.codex/harness-codex use-skill`
...
1. Verify installation: `ls ~/.codex/harness/skills`
2. Check CLI works: `~/.codex/harness/.codex/harness-codex find-skills`
