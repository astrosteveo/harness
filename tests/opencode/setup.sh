...
mkdir -p "$HOME/.config/opencode/harness"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/harness/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/harness/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/harness/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/harness.js" "$HOME/.config/opencode/harness/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/harness/.opencode/plugin/harness.js" \
       "$HOME/.config/opencode/plugin/harness.js"
...
echo "Plugin installed to: $HOME/.config/opencode/harness/.opencode/plugin/harness.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/harness.js"
